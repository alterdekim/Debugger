	...
	<body class="h-full">
		<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
		  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
			<img class="mx-auto h-10 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="Debugger">
		  ...
		  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
			...
			<p class="mt-10 text-center text-sm text-gray-500">
			  Not a member?
			  <a href="/signup.cfm" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Sign up</a>
			</p>
		  </div>
		</div>
	</body>
